...
export const FarmItem = () => {
    return (
        <Flex gap={6} minW={330} _hover={{ bg: 'gray.50' }} _focus={{ bg: 'gray.50' }} alignItems={'center'} p={2} borderRadius={'md'} transition={'background .5s'}>
            <Icons.IconFarm2 w={'50px'} h={'50px'} mixBlendMode={'multiply'} ml={6} />
